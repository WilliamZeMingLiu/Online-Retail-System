...
{
    Product* p = new Book(isbn_, author_, "book", prodName_, price_, qty_);
    return p;
}
...
{
    Product* p = new Clothing(size_, brand_, "clothing", prodName_, price_, qty_);
    return p;
...
{
    Product* p = new Movie (genre_, rating_, "movie", prodName_, price_, qty_);
    return p;
}
